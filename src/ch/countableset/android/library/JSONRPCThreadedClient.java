package ch.countableset.android.library;
...
import ch.countableset.android.library.JSONRPCParams.Versions;
...
public abstract class JSONRPCThreadedClient {
	 ...
	 */
	public void call(final String method,
			final OnObjectResultListener listener, final Object... params) {
	 ...
	 */
	public void call(final String method,
			final OnObjectResultListener onResultListener,
	 ...
	 *             if an error is encountered during JSON-RPC method call
	 */
	public void callString(final String method,
			final OnStringResultListener listener, final Object... params)
			throws JSONRPCException {
		final Handler handler = new Handler() {
			public void handleMessage(Message msg) {
				if (msg.obj == null)
	 ...
	 */
	public void callString(final String method,
			final OnStringResultListener listener, final JSONObject params)
			throws JSONRPCException {
		final Handler handler = new Handler() {
			public void handleMessage(Message msg) {
				if (msg.obj == null)
	 ...
	 *             if an error is encountered during JSON-RPC method call
	 */
	public void callInt(final String method,
			final OnIntResultListener listener, final Object... params) {
		final Handler handler = new Handler() {
			public void handleMessage(Message msg) {
				if (msg.obj == null)
					listener.sendErrorMessageNull();
					...
					if (object.description == Description.ERROR) {
						...
						listener.manageResult(((Integer) object.content)
								.intValue());
					}
				}
			};
				...
				try {
					...
					if (response == null) {
						mo = new MessageObject(Description.ERROR,
								new JSONRPCException("Cannot call method: "
										+ method));
					}
					mo = new MessageObject(Description.NORMAL_RESPONSE,
	 ...
	 */
	public void callInt(final String method,
			final OnIntResultListener listener, final JSONObject params) {
	...
	public void callLong(final String method,
			final OnLongResultListener listener, final Object... params) {
			...
			public void handleMessage(Message msg) {
				if (msg == null || msg.obj == null) {
					...
					if (mo.description == Description.ERROR) {
						...
						listener.manageResult(((Boolean) mo.content)
								.booleanValue());
					}
				}
			};
			...
			public void handleMessage(Message msg) {
				if (msg == null || msg.obj == null) {
					...
					if (mo.description == Description.ERROR) {
						...
						listener.manageResult(((Double) mo.content)
								.doubleValue());
					}
				}
			}
