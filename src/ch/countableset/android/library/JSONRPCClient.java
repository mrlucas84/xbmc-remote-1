...
public abstract class JSONRPCClient {
	 ...
	 *             if an error is encountered during JSON-RPC method call
	 */
	public Object call(String method, JSONObject params)
			throws JSONRPCException {
		try {
			return doRequest(method, params).get("result");
		} catch (JSONException e) {
	 ...
	 *             if an error is encountered during JSON-RPC method call
	 */
	public Object callInt(String method, JSONObject params)
			throws JSONRPCException {
		JSONObject response = null;
		try {
			response = doRequest(method, params);
	 ...
	 *             if an error is encountered during JSON-RPC method call
	 */
	public long callLong(String method, JSONObject params)
			throws JSONRPCException {
		JSONObject response = null;
		try {
			response = doRequest(method, params);
	...
	public boolean callBoolean(String method, Object... params)
		...
		try {
			...
			try {
				...
				throw new JSONRPCException("Cannot convert result to boolean",
						e1);
			} catch (JSONException e1) {
				throw new JSONRPCException("Cannot convert result to boolean",
						e1);
		...
		try {
			...
			try {
				...
				throw new JSONRPCException(
						"Cannot convert result to JSONObject", e);
			} catch (JSONException e1) {
				throw new JSONRPCException(
						"Cannot convert result to JSONObject", e);
			}
	...
	public Object call(JSONObject request) throws JSONRPCException {
		try {
